...
![App Overview](website/static/img/camera_params_feature_graph.png)
...
*   **Real-time Feature Tracking**: Check support for RAW capture, Optical Image Stabilization (OIS), Manual Exposure, Manual Focus, and more through an intuitive dashboard.
*   **Categorized Exploration**: Hundreds of parameters organized by Sensor, Lens, AE/AF/AWB, and Processing categories with **built-in search** functionality.
*   **Favorites (Coming Soon)**: Bookmark frequently checked parameters for quick access.
