...
*   **リアルタイムの機能追跡**: RAWキャプチャ、光学手ブレ補正 (OIS)、手動露出、マニュアルフォーカスなどのサポートを確認します。
*   **カテゴリ別の探索**: センサー、レンズ、AE/AF/AWB、およびプロセッシングカテゴリごとに整理された数百のパラメータ。
...
- **ライブラリ**:
    ...
    - [Glide](https://github.com/bumptech/glide): 画像読み込み。
