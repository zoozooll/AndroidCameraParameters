...
public class CameraController implements ICameraController {
			...
			if(isManualExposure) {
				...
				switch(flash_value) {
					...
					case "flash_red_eye":
						...
						if( CameraController.this.burst_type != BurstType.BURSTTYPE_NONE )
							builder.set(CaptureRequest.CONTROL_AE_MODE, CameraMetadata.CONTROL_AE_MODE_ON);
						else
     ...
     */
	public CameraController(Context context, int cameraId, final ErrorCallback preview_error_cb, final ErrorCallback camera_error_cb) {
