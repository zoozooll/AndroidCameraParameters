...
sequenceDiagram
    ...
    Note over HAL,AE: "Medição de pré-captura"

    loop "Cada quadro de pré-visualização"
        HAL-->>App: "CaptureResult"
        App->>App: "Verificar AE_STATE e FLASH_STATE"
    end
