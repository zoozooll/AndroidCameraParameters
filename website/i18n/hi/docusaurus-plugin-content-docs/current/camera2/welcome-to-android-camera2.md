...
- हमारे अपने [Android Camera Parameters](https://github.com/zoozooll/AndroidCameraParameters) की तरह एक **कैमरा क्षमता विश्लेषक**
...
दस्तावेज़ीकरण पढ़ना उपयोगी है, लेकिन कैमरा क्षमताओं को समझना तब आसान होता है जब आप किसी वास्तविक फोन से वास्तविक डेटा देख सकें। इस श्रृंखला में, हम आपके अपने डिवाइस से वास्तविक कैमरा जानकारी का पता लगाने के लिए [Android Camera Parameters](https://github.com/zoozooll/AndroidCameraParameters) का उपयोग करेंगे।
