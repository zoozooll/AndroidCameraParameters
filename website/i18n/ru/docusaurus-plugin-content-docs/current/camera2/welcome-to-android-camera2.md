...
- **Анализатор возможностей камеры**, как наш собственный [Android Camera Parameters](/)
...
Чтение документации полезно, но возможности камеры проще понять, когда вы видите реальные данные с реального телефона. В течение этого серии мы будем использовать [Android Camera Parameters](/), чтобы изучить реальную информацию о камере вашего собственного устройства.
